...
partial class NotificationSubscribeFuncSource
{
    public static TheoryData<NotificationSubscribeIn, Failure<NotificationSubscribeFailureCode>> InputInvalidTestData
        ...
        new()
        {
            {
                new(
                    systemUserId: Guid.Parse("dc028fce-4d9d-4661-be73-fbf0f3a07cf4"),
            ...
            {
                new(
                    systemUserId: Guid.Parse("94e99792-5c51-419c-8443-0934b87958d3"),
                    subscriptionData: new DailyNotificationSubscriptionData(
                        userPreference: new()
                        {
                            FlowRuntime = new(0, 0, 0),
                            WorkedHours = -10
                        })),
                new(NotificationSubscribeFailureCode.InvalidQuery, "Daily working hours cannot be less than zero")
            },
            {
                new(
                    systemUserId: Guid.Parse("9b572903-1933-4dbb-901e-023677462b56"),
            ...
            {
                new(
                    systemUserId: Guid.Parse("2fa0b63c-2403-4eff-8a43-9647a2ccd96a"),
                    subscriptionData: new WeeklyNotificationSubscriptionData(
                        userPreference: new()
                        {
            ...
            {
                new(
                    systemUserId: Guid.Parse("266e25be-1861-46f8-9e30-b1b250b277f9"),
                    subscriptionData: new WeeklyNotificationSubscriptionData(
                        userPreference: new()
                        {
                            Weekday = default,
