...
internal sealed partial class TimesheetUpdateFunc(IDataverseEntityUpdateSupplier dataverseApi) : ITimesheetUpdateFunc
{
    private static Result<TimesheetJson, Failure<TimesheetUpdateFailureCode>> BindProjectOrFailure(
        TimesheetJson timesheet, TimesheetProject project)
    {
        ...
        return Failure.Create(TimesheetUpdateFailureCode.Unknown, $"An unexpected project type: {project.Type}");
    }
}